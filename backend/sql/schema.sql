...
INSERT IGNORE INTO airports (`key`, name, iata, lat, lng, is_technical_point, in_local_network) VALUES
  ('TNR', 'Ivato', 'TNR', -18.8787, 47.5079, 0, 0),
  ('DIE', 'Toamasina', 'DIE', -18.1089697984752, 49.39269376622393, 0, 0),
  ('MJG', 'Mahajanga', 'MJG', -15.666954850137442, 46.35106480662277, 0, 0),
  ('Fort Dauphin', 'Tolagnaro', 'Fort Dauphin', -25.03644107410689, 46.95447113950406, 0, 0);
